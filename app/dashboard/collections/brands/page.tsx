        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground mt-2">
              Browse brands for {selectedCollection} ({brands.length} brands available)
            </p>
          </div>
          ...
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              Showing {startIndex + 1}-{Math.min(endIndex, filteredAndSortedBrands.length)} of {filteredAndSortedBrands.length} brands
            </p>
          </div>
                ...
                <TableBody>
                  ...
                  {topVisited.length > 0 && (
                    <TableRow className="bg-primary/5 border-b-2 border-primary/20">
                      ...
                      <TableCell colSpan={3}>
                        <div className="py-2">
                          <div className="font-semibold text-primary mb-2">🔥 Most Popular Brands</div>
                            ...
                            {topVisited.map((item, index) => (
                              ...
                              >
                                ...
                                {item.metadata
                                  ...
                                  .map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase())
                                  .join(' ')}
                                <span className="text-xs opacity-70">({item.count} clicks)</span>
                              </div>
                            ))}
                          </div>
                        </div>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <div className="font-medium truncate">{brand.title}</div>
                          </div>
                        </div>
                      </TableCell>
          ...
          {paginatedBrands.length === 0 && brands.length > 0 && (
            <div className="text-center py-12">
